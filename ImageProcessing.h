...
void Image_Processing::getPalette(char *FileOrigen,int nc) 
{ 
...
int Image_Processing::getPaletteID(BMPColor color, int tp) 
{ 
  for (int i = 0; i < tp; i++) 
...
void Image_Processing::Load(char* FileOrigen) {
...
void Image_Processing::Save(char *FileDestino) 
{ 
...
void Image_Processing::Histogram() {
...
void Image_Processing::Ecualization()  {
